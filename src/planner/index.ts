import { deletePlannerTaskTool, createPlannerTaskTool, type PlannerTool } from './tools/tasks.js';
 ...
 * so ours is the only registration ("overlay wins"). create-planner-task is
 * the first genuine collision: upstream already declares it (declarative,
 * generated-client passthrough), and this overlay's composite version
